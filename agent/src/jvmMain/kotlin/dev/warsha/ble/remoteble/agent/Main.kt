...
import dev.warsha.ble.remoteble.agent.di.AgentConfig
import dev.warsha.ble.remoteble.agent.di.agentModule
...
fun main(args: Array<String>) {
    ...
    Runtime.getRuntime().addShutdownHook(
        Thread {
            println("Shutting down Remote BLE agent...")
    ...
    println("Remote BLE agent listening on ws://0.0.0.0:${config.port}/agent ($auth, $excl peripherals, Kable engine on $host)")
